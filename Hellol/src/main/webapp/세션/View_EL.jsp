...
<form>
	<table border="1" width="90%">
		...
		<tr>
			<th>내용</th>
			<td colspan="4" ><textarea name = "content" style="width:90%; height:100px;">${board.content }</textarea></td>
		</tr>
		<tr align="center">
			<td colspan="5">
				...
				<button type="button" onclick="location.href='Edit.jsp?num=${board.num }'">수정하기</button>
